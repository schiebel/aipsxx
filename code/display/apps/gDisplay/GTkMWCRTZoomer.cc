//# GTkMWCRTZoomer.cc: Glish/Tk implementation of WorldCanvas event-based zooming
...
//#
//# $Id: GTkMWCRTZoomer.cc,v 19.5 2005/06/15 18:09:13 cvsmgr Exp $
...
GTkMWCRTZoomer::GTkMWCRTZoomer(GTkMultiPanel* gtkpdisplay,
...
GTkMWCRTZoomer::~GTkMWCRTZoomer() {
}

void GTkMWCRTZoomer::zoomed(const Vector<Double>& blc, 
