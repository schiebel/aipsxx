//# GTkMWCPTRegion.cc: GlishTk-based MultiPanel polygon region drawing
...
namespace casa {
GTkMWCPTRegion::GTkMWCPTRegion(GTkMultiPanel *gtkpdisplay,
...
GTkMWCPTRegion::~GTkMWCPTRegion() {
}

void GTkMWCPTRegion::regionReady() {
  GlishRecord emit, pixel, linear, world;
  
  emit.add(String("type"), GlishArray(String("polygon")));
...
void GTkMWCPTRegion::polygonReady() {
