...
//#
//# $Id: WCAxisLabeller.cc,v 19.6 2005/09/07 21:26:24 dking Exp $
...
WCAxisLabeller::WCAxisLabeller() {
  ...
  String onoff;
  Aipsrc::find(onoff,"display.axislabels","off");
...
Record WCAxisLabeller::getOptions() const 
{
  ...
  Vector<String> vcolors(8);
  vcolors(0) = "foreground"; vcolors(1) = "background";
  vcolors(2) = "black"; vcolors(3) = "white";
  vcolors(4) = "red"; vcolors(5) = "green";
  vcolors(6) = "blue"; vcolors(7) = "yellow";
  titletextcolor.define("popt", vcolors);
  ...
  xaxistextcolor.define("popt", vcolors);
  ...
  yaxistextcolor.define("popt", vcolors);
  ...
  xgridcolor.define("popt", vcolors);
  ...
  ygridcolor.define("popt", vcolors);
  ...
  plotoutlinecolor.define("popt", vcolors);
  ...
  labelcharsize.define("pmin", Float(0.0));
