...
//# 
//# $Id: WCPowerScaleHandler.h,v 19.5 2005/06/15 17:59:16 cvsmgr Exp $
...
class WCPowerScaleHandler  : public WCDataScaleHandler {
 ...
 public:
  ...
  // <group>
  void setCycles(Float cyc) { itsOptionsPowerCycles = cyc; }
  Float cycles() { return itsOptionsPowerCycles; }
  // </group>
