...
//# 
//# $Id: CrosshairEvent.h,v 19.6 2005/06/15 18:02:22 cvsmgr Exp $
...
class CrosshairEvent : public WorldCanvasEvent {
 ...
 public:
  ...
  // <group>
  virtual Int pixX() const { return itsPixX; }
  virtual Int pixY() const { return itsPixY; }
  virtual String evtype() const { return itsEvType; }
  // </group>
