...
//#
//# $Id: MWCPolylineTool.cc,v 1.5 2005/06/15 18:02:23 cvsmgr Exp $
...
void MWCPolylineTool::moved(const WCMotionEvent &ev) {
...
void MWCPolylineTool::draw(const WCRefreshEvent &) { 
