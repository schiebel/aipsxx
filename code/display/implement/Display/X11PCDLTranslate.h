//# X11PCDLTranslate.h: X11 PixelCanvas store/cache of Translate command
...
//# 
//# $Id: X11PCDLTranslate.h,v 19.4 2005/06/15 17:56:43 cvsmgr Exp $

#ifndef TRIALDISPLAY_X11PCDLTRANSLATE_H
#define TRIALDISPLAY_X11PCDLTRANSLATE_H
...
//
// <summary>
// X11 display list object that stores the translate command  
// </summary>
//
...
// Display List translate command
// </etymology>
//
// <synopsis>
...
// caching mechanism.
//
// Cached version of the translate command which can be used
// in display lists.
// </synopsis>
//
// <motivation>
...
class X11PCDLTranslate  : public X11PCDisplayListObject {
 ...
 public:
  ...
  virtual Char optType() const { return 'w'; }
