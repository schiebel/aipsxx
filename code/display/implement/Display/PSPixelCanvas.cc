...
//#
//# $Id: PSPixelCanvas.cc,v 19.5 2005/06/15 17:56:29 cvsmgr Exp $
...
{
	clipx0_ = (Float)x1; clipy0_ = (Float)y1;
	clipx1_ = (Float)x2; clipy1_ = (Float)y2;
	haveClipInfo_ = True;
}

void PSPixelCanvas::getClipWindow(Int & x1, Int & y1, Int & x2, Int & y2)
{
	x1 = (Int)clipx0_; y1 = (Int)clipy0_;
	x2 = (Int)clipx1_; y2 = (Int)clipy1_;
}
