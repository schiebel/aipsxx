...
//# 
//# $Id: GLPixelCanvasColorTable.cc,v 19.5 2005/06/15 17:56:28 cvsmgr Exp $
...
uInt GLPixelCanvasColorTable::nColors() const { return nColors_; }
uInt GLPixelCanvasColorTable::depth() const { return depth_; }
uInt GLPixelCanvasColorTable::nSpareColors() const {
	return QueryColorsAvailable(False); }
::XDisplay * GLPixelCanvasColorTable::display() const { return display_; }
Screen * GLPixelCanvasColorTable::screen() const { return screen_; }
Visual * GLPixelCanvasColorTable::visual() const { return visualInfo_->visual;}
XColormap GLPixelCanvasColorTable::xcmap() const { return xcmap_; }
...
{	if(vi != NULL)
	...
	if((visualInfo_ = getVisualInfo(display_, colorModel_)) == NULL)
		return False;
