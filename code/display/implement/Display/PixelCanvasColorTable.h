...
//#
//# $Id: PixelCanvasColorTable.h,v 19.5 2005/06/15 17:56:30 cvsmgr Exp $
...
// PixelCanvasColorTable for each <lintko class="PixelCanvas">PixelCanvas</linkto>.
...
public:
  ...
  // array.  
  // <note rol="tip"The choice of what type to use should be guided by
  ...
  // with an alpha channel may require using the uLong.
  //
