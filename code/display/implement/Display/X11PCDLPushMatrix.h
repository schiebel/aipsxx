//# X11PCDLPushMatrix.h: X11 PixelCanvas store/cache of PushMatrix command
...
//# 
//# $Id: X11PCDLPushMatrix.h,v 19.4 2005/06/15 17:56:43 cvsmgr Exp $

#ifndef TRIALDISPLAY_X11PCDLPUSHMATRIX_H
#define TRIALDISPLAY_X11PCDLPUSHMATRIX_H
...
//
// <summary>
// X11 display list object that stores the pushMatrix command  
// </summary>
//
...
// Display List PushMatrix command
// </etymology>
//
// <synopsis>
...
// caching mechanism.
//
// Cached version of the pushMatrix command which can be used
// in display lists.
// </synopsis>
//
// <motivation>
...
class X11PCDLPushMatrix  : public X11PCDisplayListObject {
 ...
 public:
  ...
  // User Constructor
  X11PCDLPushMatrix(X11PixelCanvas * xpc);
  ...
  virtual Char optType() const { return 'r'; }

  // Destructor
  virtual ~X11PCDLPushMatrix();
