...
//#
//# $Id: TblAsContourDD.cc,v 19.4 2005/06/15 18:00:46 cvsmgr Exp $
...
Record TblAsContourDD::getOptions() {
  ...
  vlevels(0) = 0.0; vlevels(1) = 1.0; vlevels(2) = 2.0;
  vlevels(3) = 3.0; vlevels(4) = 4.0; vlevels(5) = 5.0;
  vlevels(6) = 6.0; vlevels(7) = 7.0; vlevels(8) = 8.0;
  vlevels(9) = 9.0; vlevels(10) = 10.0;
...
void TblAsContourDD::installDefaultOptions() {
  ...
  itsLevels.resize(11);
  itsLevels(0) = 0.0; itsLevels(1) = 1.0; itsLevels(2) = 2.0;
  itsLevels(3) = 3.0; itsLevels(4) = 4.0; itsLevels(5) = 5.0;
  itsLevels(6) = 6.0; itsLevels(7) = 7.0; itsLevels(8) = 8.0;
  itsLevels(9) = 9.0; itsLevels(10) = 10.0; 
  itsScale = 0.1;
  itsType = "frac";
  itsLine = 0.5;
  itsDash = True;
