//# tTblAsXY.cc: test rastering of tables on PostScript and X11 canvases
...
//#
//# $Id: tTblAsXY.cc,v 19.5 2005/06/15 18:01:33 cvsmgr Exp $
...
main(int argc, char **argv) {
  ...
  try {
    ...
    if (reqCanvas == String("ps")) {
      psdriver = new PSDriver("tTblAsXY.ps", PSDriver::A4, 
			      PSDriver::LANDSCAPE);
    ...
    TblAsXYDD *tardd1 = 0;
    tardd1 = new TblAsXYDD(filename1);
    if (!tardd1) {
