//# tTblAsContour.cc: test contouring of tables on PostScript and X11 canvases
...
//#
//# $Id: tTblAsContour.cc,v 19.5 2005/06/15 18:01:32 cvsmgr Exp $
...
main(int argc, char **argv) {
  ...
  try {
    ...
    if (reqCanvas == String("ps")) {
      psdriver = new PSDriver("tTblAsContour.ps", PSDriver::A4, 
			      PSDriver::LANDSCAPE);
    ...
    tardd1 = new TblAsContourDD(filename1);
    if (!tardd1) {
    ...
    Vector<Float> levels;
    levels.resize(11);
    levels(0) = 0.; levels(1) = 1.; levels(2) = 2.; levels(3) = 3.;
    levels(4) = 4.; levels(5) = 5.; levels(6) = 6.; levels(7) = 7.;
    levels(8) = 8.; levels(9) = 9.; levels(10) = 10.; 
    Record rec, recOut;
