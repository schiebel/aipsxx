...
//#
//#
//# $Id: TblAsContourDD.h,v 19.6 2005/06/18 21:19:15 ddebonis Exp $

#ifndef TRIALDISPLAY_TBLASCONTOURDD_H
#define TRIALDISPLAY_TBLASCONTOURDD_H
...
//
// <etymology>
// "TblAsContourDD" is a implementation of a <linkto class=ActiveCaching2dDD>
// ActiveCaching2dDD </linkto> which provides for the display of data held 
// within a table to be displayed as a contour image in an environment where
...
// <srcblock>
//    TblAsContourDD *tardd1 = 0;
//    tardd1 = new TblAsContourDD("tablename");
...
class TblAsContourDD : public ActiveCaching2dDD {
 ...
 public:
  ...
  // Create a new TblAsContourDM for drawing on the given
...
#include <display/DisplayDatas/TblAsContourDD.cc>
