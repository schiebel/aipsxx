...
//#
//# $Id: DisplayData.h,v 19.8 2006/01/18 23:52:15 dking Exp $
...
public:   
  ...
  // (Generally, DDs should probably override setActiveZIndex()
  ...
  virtual Bool getFirstZIndex(int& firstZIndex, Int axZrng=-1) const {
    ...
    firstZIndex=zInds[0];    return True;  }
...
protected:
  ...
  // by setActiveZIndex() in this class or derived classes.
  Int activeZIndex_;
  ...
  // conformsToRstrs(), conformsToCS() and setActiveZIndex(), respectively.
