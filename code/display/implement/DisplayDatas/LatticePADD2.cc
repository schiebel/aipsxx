...
//#
//# $Id: LatticePADD2.cc,v 19.10 2005/12/14 18:25:57 dking Exp $
...
Bool LatticePADisplayData<Complex>::updateHistogram(Record &rec,
  ...
  switch (itsComplexToRealMethod) {
    case Display::Phase:      
      floatLattice = new LatticeExpr<Float>(arg(pImage));   break;
    case Display::Real:
      floatLattice = new LatticeExpr<Float>(real(pImage));  break;
    case Display::Imaginary:
      floatLattice = new LatticeExpr<Float>(imag(pImage));  break;
    default:
