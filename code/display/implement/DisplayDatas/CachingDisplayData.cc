...
//#
//# $Id: CachingDisplayData.cc,v 19.9 2005/06/15 18:00:34 cvsmgr Exp $
...
void CachingDisplayData::refreshEH(const WCRefreshEvent &ev) {
  ...
  delete wchRestrictions;wchRestrictions=0;
  delete ddRestrictions;ddRestrictions=0;
