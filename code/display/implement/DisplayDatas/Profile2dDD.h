...
//#
//# $Id: Profile2dDD.h,v 19.9 2005/06/15 18:00:46 cvsmgr Exp $
...
class Profile2dDD : public ActiveCaching2dDD, public WCMotionEH,
  ...
  // single point
  virtual const Bool isRegionProfile() const {return itsIsRegionProfile;
  }
  ...
  virtual const Double restFrequency()  const {return itsRestFrequency;}  
  ...
  // create a region
  virtual const Int regionXRadius()  const {return itsParamRegionXRadius->value();}
