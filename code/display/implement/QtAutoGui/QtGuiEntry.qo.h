...
//#
//# $Id: QtGuiEntry.qo.h,v 1.2 2006/08/31 23:42:38 gvandiep Exp $
...
class QtSliderBase : public QWidget {
 ...
 public:
  ...
  // Set up main internal state (value, etc.) and external appearance of
  // this widget, according to options record (passed as a QDomElement).
  // Called via constructor, and from QtAutoGui::changeOptions().
  // Does not trigger (significant) signals; it is intended to sync this
  // interface element with library internal state (not vice versa).
