...
//#
//# $Id: QtDisplayPanelGui.cc,v 1.10 2006/09/27 23:50:54 hye Exp $
...
QtDisplayPanelGui::QtDisplayPanelGui(QtViewer* v, QWidget *parent) :
  ...
  tlMenu_        = menuBar()->addMenu("&Tool");
   anotAct_     = tlMenu_->addAction("A&notating...");
  ...
  // Set interface according to animator's initial state.
...
void QtDisplayPanelGui::updateAnimUi_() {
  ...
  //      interface which is not yet fully supported).
...
//******** Other (Indirect / Internal) slots and methods. *********
