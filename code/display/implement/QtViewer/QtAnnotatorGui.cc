...
//#
//# $Id: QtAnnotatorGui.cc,v 1.2 2006/09/27 15:11:21 hye Exp $
//#
...
const QString QtAnnotatorGui::basebitmaps[] =
    {"pointer0.xbm", "dsmove.xbm" , "delete.xbm",
     "dsarrow.xbm", "dstext.xbm", "dsrectangle.xbm", "dssquare.xbm",
     "dspolyline.xbm", "dspoly.xbm",  "dsellipse.xbm", "dscircle.xbm", 
     "dsmarker.xbm"
    };

const QString QtAnnotatorGui::markerbitmaps[] =
    {"markercircx.xbm","markersqr.xbm",  "markercross.xbm","markerx.xbm",
     "markerdia.xbm",  "markercirc.xbm",  "markertri.xbm", "markeritri.xbm",
     "markerfcirc.xbm", "markerfsqr.xbm", "markerfdia.xbm",   "markerftri.xbm",
...
void QtAnnotatorGui::setup()
{
    ...
    pushButton2->setIcon(QIcon(QString::fromUtf8(":/icons/downarrow.xbm")));
    ...
    toolButton13->setIcon(QIcon(QString::fromUtf8(":/icons/spanner.xbm")));
    hboxLayout4->addWidget(toolButton13);

    label2 = new QLabel(verticalLayout_4);
    label2->setObjectName(QString::fromUtf8("label2"));
    label2->setPixmap(QPixmap(QString::fromUtf8(":/icons/tick.xbm")));
              ...
              const Qt::MouseButton key, const bool getOption)
{
    ...
    QtXmlRecord xmlRec;
    Record rec = annot->availableShapes(); 
    xmlRec.printRecord(&rec);
