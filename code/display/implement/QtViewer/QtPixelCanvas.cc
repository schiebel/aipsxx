...
//#
//# $Id: QtPixelCanvas.cc,v 1.7 2006/10/10 21:42:05 dking Exp $
...
void QtPixelCanvas::drawPoint(Int x1, Int y1) {
  //#diag cerr << "drawPoint i" << endl;	//#diag -- not seen so far
}

void QtPixelCanvas::drawPoint(Float x1, Float y1) {
  //#diag cerr << "drawPoint f" << endl;	//#diag -- not seen so far
}

void QtPixelCanvas::drawPoint(Double x1, Double y1) {
  //#diag cerr << "drawPoint d" << endl;	//#diag -- not seen so far
}
...
void QtPixelCanvas::drawLine(Float x1, Float y1, Float x2, Float y2) {
  //#diag cerr << "drawLine called f" << endl;	//#diag -- not seen so far
  //fill
}
...
void QtPixelCanvas::drawLines(const Matrix<Int> &verts) {
  //#diag cerr << "drawLines called i" << endl;	//#diag -- not seen so far
}

void QtPixelCanvas::drawLines(const Matrix<Double> &verts) {
  //#diag cerr << "drawLine called d" << endl;	//#diag -- not seen so far
}
...
QColor gr(Qt::green);
cerr<<gr.red()<<"*"<<gr.green()<<"*"<<gr.blue()<<endl;//#diag
QColor gr("green");
cerr<<gr.red()<<"*"<<gr.green()<<"*"<<gr.blue()<<endl;//#diag
