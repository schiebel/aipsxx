/*    sv.h
 *
 *    $Id: sv.h,v 19.0 2003/07/16 05:18:04 aips2adm Exp $
...
struct magic {
    MAGIC_T*      mg_moremagic;
    void*       mg_virtual;     /* pointer to magic functions */
    U16         mg_private;
    char        mg_type;
    U8          mg_flags;
    SV*         mg_obj;
...
struct xpvmg {
    ...
    IV		xiv_iv;		/* integer value or pv offset */
    double	xnv_nv;		/* numeric value, if any */
    MAGIC_T*	xmg_magic;	/* linked list of magicalness */
