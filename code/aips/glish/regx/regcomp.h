 ...
 *
 *      $Id: regcomp.h,v 19.0 2003/07/16 05:18:03 aips2adm Exp $
 ...
 * that regxcomp() supplies a regmust only if the r.e. contains something
 * potentially expensive (at present, the only such thing detected is * or +
 * at the start of the r.e., which can involve a lot of backup).  Regmlen is
 * supplied because the test in regxexec() needs it and regxcomp() is computing
 * it anyway.
...
EXT I32 ibcmp _((char *, char *, I32 len));
EXT I32 ibcmp_locale _((char *, char *, I32 len));
