 ...
 *
 *      $Id: regcomp.c,v 19.0 2003/07/16 05:18:02 aips2adm Exp $
...
/*
 * Forward declarations for regxcomp()'s friends.
 */
...
static UV scan_oct _((char *, I32, I32 *));
static UV scan_hex _((char *, I32, I32 *));

/*
 - regxcomp - compile a regular expression into internal code
 *
...
static UV scan_oct(start, len, retlen)
char *start;
I32 len;
I32 *retlen;
{
...
static UV scan_hex(start, len, retlen)
char *start;
I32 len;
I32 *retlen;
{
