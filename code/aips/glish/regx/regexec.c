 ...
 * regexec to  regxcomp and regxexec in order to avoid conflicts
 ...
 *
 *      $Id: regexec.c,v 19.0 2003/07/16 05:18:03 aips2adm Exp $
...
/*
 - regxexec - match a regexp against a string
 */
I32
regxexec(prog, stringarg, strend, strbeg, minend, screamer, safebase)
