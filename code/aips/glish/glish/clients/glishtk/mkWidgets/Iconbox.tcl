...
metawidget proc Iconbox iconcget { sIcon args } {
  ...
  switch -- $sOption {
    -icon      { return [lindex [my aIcons($sItem)] 0] }
    -smallicon { return [lindex [my aIcons($sItem)] 1] }
    -values    { return [lindex [my aIcons($sItem)] 2] }
    -user      { return [lindex [my aIcons($sItem)] 4] }
    default    {
      set wIcon [lindex [my aIcons($sIcon)] 3]
