...
# $Id: aipsinit.csh,v 19.8 2007/01/25 04:11:51 mcalabre Exp $
#=============================================================================
...
# Increase number of available file descriptors.
  set a_fds = `limit descriptors | awk '{print $2}'`
  if ("$a_fds" != unlimited && "$a_fds" < 1024) then
     # Do not exceed the hard limit.
     set a_fds = `limit -h descriptors | awk '{print $2}'`
     if ("$a_fds" == unlimited || "$a_fds" > 1024) then
