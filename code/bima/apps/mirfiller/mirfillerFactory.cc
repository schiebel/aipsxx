...
//#
//# $Id: mirfillerFactory.cc,v 19.2 2004/11/30 17:50:11 ddebonis Exp $
...
MethodResult mirfillerFactory::make(ApplicationObject *&newObject,
				    ...
				    Bool runConstructor)
{
    ...
    if (whichConstructor == "mirfiller") {
	Parameter<String> mirfile(parameters, "mirfile", ParameterSet::In);
	if (runConstructor) {
	    newObject = new mirfiller(mirfile());
	} 
    } 
    else {
