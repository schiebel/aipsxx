...
//#
//# $Id: qimagerFactory.cc,v 1.6 2005/11/07 21:17:04 wyoung Exp $

#include <../qimager/qimagerFactory.h>
...
MethodResult qimagerFactory::make(ApplicationObject *&newObject,
  ...
  if (whichConstructor == "qimager") {
    ...
    if (runConstructor) {
      MeasurementSet thisms(thems(), TableLock(TableLock::UserLocking),
			    Table::Update);
      newObject = new qimager(thisms, compress());
    }
  } else {
