...
//#
//#! ========================================================================
//# $Id: DOchebyshev.h,v 19.5 2004/11/30 17:50:09 ddebonis Exp $

#ifndef APPSGLISH_DOCHEBYSHEV_H
#define APPSGLISH_DOCHEBYSHEV_H
...
// <summary>
// class for creating and accessing Chebyshev objects from Glish
// </summary>
...
//    <li> adapt to new Functionals framework
// </todo>
class chebyshev : public ApplicationObject {
private:

    MarshallableChebyshev<Double> cheb;
    LogIO log_p;
...
//      static GlishRecord marshall(Chebyshev<Double> &c);
    void logSummary();
