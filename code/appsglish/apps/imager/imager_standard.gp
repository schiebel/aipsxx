# imager_standard.gp: Standard plugins for AIPS++ imager class
#
...
#
#   $Id: imager_standard.gp,v 19.1 2004/08/25 01:20:20 cvsmgr Exp $
#
...
imager_standard := [=];
imager_standard.init := function()
{
  types.class('imager').group('calibrate').method('imager.selfcal').group().
...
const imager_standard := const imager_standard;
