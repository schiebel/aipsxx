...
#
#   $Id: pgplotwidget2.g,v 19.1 2004/08/25 01:17:16 cvsmgr Exp $
#
pragma include once;

include 'widgetserver.g';
include 'unset.g';
print '### PGPLOTWIDGET 2!';

### Main documentation is in the reference manual.

const pgplotwidget2 := function(ref parentframe, size=[600,450],
				...
				widgetset=dws)
{
    ...
    public := pgplotmanager(private.pgplot, askfunction=pgplotaskviagui, 
			    widgetset=widgetset);
...
#    private.pgplot.private := ref private;
    ...
    public.setcallback := function(onames, callback) {
        ...
        whenever private.pgplot->[names] do callback($value);
...
# const pgplotwidget := pgplotwidget2;
