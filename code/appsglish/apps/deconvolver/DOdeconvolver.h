...
#ifndef APPSGLISH_DODECONVOLVER_H
#define APPSGLISH_DODECONVOLVER_H
...
class deconvolver : public ApplicationObject
{
public:
  // "deconvolver" ctor
  deconvolver();
