...
//#
//# $Id: tImagePolarimetry.cc,v 19.6 2005/12/06 20:18:51 wyoung Exp $
// 
//
...
//
     ...
     {
        ImageExpr<Complex> ie = pol.complexFractionalLinearPolarization();
        Complex val(qVal/iVal,uVal/iVal);
        AlwaysAssert(allNear(ie.get(), val, 1e-6), AipsError);
     }
     {
