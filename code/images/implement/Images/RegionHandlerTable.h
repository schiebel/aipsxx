//# RegionHandlerTable.h: Class for keeping regions in memory
//# Copyright (C) 2000
...
//#
//# $Id: RegionHandlerTable.h,v 19.4 2004/11/30 17:50:27 ddebonis Exp $
...
class RegionHandlerTable: public RegionHandler
{
public: 
...
private:
  ...
  // <group>
  Table& rwTable()
    { return itsCallback (itsObjectPtr, True); }
  const Table& table() const
    { return itsCallback (const_cast<RegionHandlerTable*>(this)->itsObjectPtr,
			  False); }
  // </group>
