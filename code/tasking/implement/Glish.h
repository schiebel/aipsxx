...
// </summary>
//
// <reviewed reviewer="pshannon" date="28OCT94" demos="dGlish">
//
// <synopsis>
...
// <ul>
//    <li> <linkto class=GlishValue>GlishValue</linkto> is the class for all
...
//    <li> <linkto class=GlishArray>GlishArray</linkto> is a (possibly 
...
//    <li> <linkto class=GlishRecord>GlishRecord</linkto> is a "structure" of
//           values, made up of named arrays and records (the latter makes it
//           hierarchical).
//    <li> <linkto class=GlishSysEvent>GlishSysEvent</linkto> is a named value
//           which has been sent from an external source.
//    <li> <linkto class=GlishSysEventSource>GlishSysEventSource</linkto> the
...
//    <li> <linkto class=XSysEventSource>XSysEventSource</linkto> allows the
//           user to handle both Glish and X events using the same event
//           loop. See XSysEventSource for
//           <linkto class=XSysEvent#event_example>an example</linkto>.
// </ul>
...
// could easily be a <linkto class=XSysEvent#event_example>windowing
// application</linkto>.
// 
...
// by AIPS++ programmers, e.g. <linkto class=GlishArray:description>GlishArray
// </linkto>.
// </motivation>
//
