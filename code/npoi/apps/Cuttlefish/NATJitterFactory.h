...
Description:
------------
This file contains the include information for the NATJitterFactory.cc file.
...
#ifndef NPOI_NATJITTERFACTORY_H
#define NPOI_NATJITTERFACTORY_H
...
class NATJitterFactory : public ApplicationObjectFactory {
