...
Description:
------------
This file contains the include information for the ScanInfoFactory.cc file.
...
#ifndef NPOI_SCANINFOFACTORY_H
#define NPOI_SCANINFOFACTORY_H
...
class ScanInfoFactory : public ApplicationObjectFactory {
