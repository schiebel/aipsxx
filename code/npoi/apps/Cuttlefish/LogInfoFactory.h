...
Description:
------------
This file contains the include information for the LogInfoFactory.cc file.
...
#ifndef NPOI_LOGINFOFACTORY_H
#define NPOI_LOGINFOFACTORY_H
...
#include <npoi/Cuttlefish/LogInfo.h>        // LogInfo class
...
class LogInfoFactory : public ApplicationObjectFactory {
