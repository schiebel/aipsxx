# __gdc1token_zoom.g is part of the GDC server
...
#
# $Id: __gdc1token_zoom.g,v 19.0 2003/07/16 06:03:30 aips2adm Exp $
# ------------------------------------------------------------------------------
...
# Description:
# ------------
# This file contains the glish functions for zooming in gdc1token tools.  NB:
# These functions should be called only by gdc1token tools.

# glish function:
# ---------------
# __gdc1token_zoomprivate, __gdc1token_zoomgui.

# Modification history:
# ---------------------
# 2000 Jun 02 - Nicholas Elias, USNO/NPOI
#               File created with glish functions __gdc1token_zoomprivate( )
#               and __gdc1token_zoomgui{ }.
...
# __gdc1token_zoomprivate

# Description:
# ------------
# This glish function creates zoom private member functions for a gdc1token
# tool.
...
const __gdc1token_zoomprivate := function( ref private ) {
...
# Description:
# ------------
# This glish function creates a zoom GUI for a gdc1token tool.
...
const __gdc1token_zoomgui := function( ref gui, ref w, ref private, public ) {
