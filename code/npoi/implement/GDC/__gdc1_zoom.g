# __gdc1_zoom.g is part of the GDC server
...
#
# $Id: __gdc1_zoom.g,v 19.0 2003/07/16 06:03:35 aips2adm Exp $
# ------------------------------------------------------------------------------
...
# Description:
# ------------
# This file contains the glish functions for zooming in gdc1 tools.  NB: These
# functions should be called only by gdc1 tools.

# glish function:
# ---------------
# __gdc1_zoomprivate, __gdc1_zoomgui.

# Modification history:
# ---------------------
# 2000 Jun 02 - Nicholas Elias, USNO/NPOI
#               File created with glish functions __gdc1_zoomprivate( ) and
#               __gdc1_zoomgui{ }.
...
# Description:
# ------------
# This glish function creates zoom private member functions for a gdc1 tool.
...
const __gdc1_zoomprivate := function( ref private ) {
...
# Description:
# ------------
# This glish function creates a zoom GUI for a gdc1 tool.
...
const __gdc1_zoomgui := function( ref gui, ref w, ref private, public ) {
