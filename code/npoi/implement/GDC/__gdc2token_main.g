# __gdc2token_main.g is part of the GDC server
...
#
# $Id: __gdc2token_main.g,v 19.0 2003/07/16 06:03:38 aips2adm Exp $
# ------------------------------------------------------------------------------
...
# Description:
# ------------
# This file contains the glish functions for the main gui in gdc2token tools.
# NB: These functions should be called only by gdc2token tools.

# glish function:
# ---------------
# __gdc2token_maingui, __gdc2token_maingui_reset, __gdc2token_maingui_topbar,
# __gdc2token_maingui_bottombar, __gdc2token_maingui_file,
# __gdc2token_maingui_hardcopy, __gdc2token_maingui_size,
# __gdc2token_maingui_tools, __gdc2token_maingui_help.

# Modification history:
# ---------------------
# 2001 Jan 17 - Nicholas Elias, USNO/NPOI
#               File created with glish functions __gdc2token_maingui( ),
#               __gdc2token_maingui_topbar( ), __gdc2token_maingui_bottombar( ),
#               __gdc2token_maingui_file( ), __gdc2token_maingui_hardcopy( ),
#               __gdc2token_maingui_reset( ), __gdc2token_maingui_size( ),
#               __gdc2token_maingui_tools( ), and __gdc2token_maingui_help( ).
...
# Description:
# ------------
# This glish function creates a main GUI for a gdc2token tool.
...
const __gdc2token_maingui := function( window, ref gui, ref w, ref private,
    public ) {
  ...
  __gdc2token_maingui_topbar( gui, w, private, public );

  private.pgplot();

  __gdc2token_maingui_bottombar( gui, w, private, public );
...
# __gdc2token_maingui_reset

# Description:
# ------------
# This glish function resets all GUIs for a gdc2token tool.
...
const __gdc2token_maingui_reset := function( ref gui, ref private, public ) {
  ...
  private.setline( T );
  private.setkeep( F );
  private.settoken( private.tokenlist() );
  for ( t in 1:length(private.tokenlist() ) ) {
    private.setcolumn( private.tokenlist()[t], private.columnlist() );
  }
...
# __gdc2token_maingui_topbar

# Description:
# ------------
# This glish function creates the top bar for the main GUI of a gdc2token tool.
...
const __gdc2token_maingui_topbar := function( ref gui, ref w, ref private,
    public ) {
  ...
  __gdc2token_maingui_file( gui, w, private, public );
  
  __gdc2token_maingui_tools( gui, w, private, public );
  __gdc2token_maingui_help( gui, w, private, public );
...
# __gdc2token_maingui_bottombar

# Description:
# ------------
# This glish function creates the bottom bar for the main GUI of a gdc2token
# tool.
...
const __gdc2token_maingui_bottombar := function( ref gui, ref w, ref private,
    public ) {
  ...
  whenever gui.resetgui->press do {
    ...
    __gdc2token_maingui_reset( gui, private, public );
  }
...
# __gdc2token_maingui_file

# Description:
# ------------
# This glish function creates the file menu for the main GUI of a gdc2token
# tool.
...
const __gdc2token_maingui_file := function( ref gui, ref w, ref private,
    public ) {
  ...
  whenever gui.bdumpascii->press do {
    __gdc2token_maingui_dumpascii( gui, w, private, public );
  }
  ...
  whenever gui.bsize->press do {
    __gdc2token_maingui_size( gui, w, private, public );
  }
  ...
  whenever gui.bhardcopy->press do {
    __gdc2token_maingui_hardcopy( gui, w, private, public );
  }
...
# __gdc2token_maingui_dumpascii

# Description:
# ------------
# This glish function creates the dumpascii GUI for the main GUI of a gdc2token
# tool.
...
const __gdc2token_maingui_dumpascii := function( ref gui, ref w, ref private,
    public ) {
...
# __gdc2token_maingui_hardcopy

# Description:
# ------------
# This glish function creates the hardcopy GUI for the main GUI of a gdc2token
# tool.
...
const __gdc2token_maingui_hardcopy := function( ref gui, ref w, ref private,
    public ) {
...
# __gdc2token_maingui_size

# Description:
# ------------
# This glish function creates the size GUI for the main GUI of a gdc2token
# tool.
...
const __gdc2token_maingui_size := function( ref gui, ref w, ref private,
    public ) {
...
# __gdc2token_maingui_tools

# Description:
# ------------
# This glish function creates the tools menu for the main GUI of a gdc2token
# tool.
...
const __gdc2token_maingui_tools := function( ref gui, ref w, ref private,
    public ) {
...
# __gdc2token_maingui_help

# Description:
# ------------
# This glish function creates the help menu for the main GUI of a gdc2token
# tool.
...
const __gdc2token_maingui_help := function( ref gui, ref w, ref private,
    public ) {
