# __gdc2token_edit.g is part of the GDC server
...
#
# $Id: __gdc2token_edit.g,v 19.0 2003/07/16 06:03:37 aips2adm Exp $
# ------------------------------------------------------------------------------
...
# Description:
# ------------
# This file contains the glish functions for editing in gdc2token tools.  NB:
# These functions should be called only by gdc2token tools.

# glish function:
# ---------------
# __gdc2token_editprivate, __gdc2token_editgui, __gdc2token_editgui_update.

# Modification history:
# ---------------------
# 2001 Jan 06 - Nicholas Elias, USNO/NPOI
#               File created with glish functions __gdc2token_editprivate( ).
...
# __gdc2token_editprivate

# Description:
# ------------
# This glish function creates edit private member functions for a gdc2token
# tool.
...
const __gdc2token_editprivate := function( ref private ) {
...
# Description:
# ------------
# This glish function creates an edit GUI for a gdc2token tool.
...
const __gdc2token_editgui := function( ref gui, ref w, ref private, public ) {
...
# __gdc2token_editgui_update

# Description:
# ------------
# This glish function updates an edit GUI for a gdc2token tool.
...
const __gdc2token_editgui_update := function( ref gui, ref private, public ) {
