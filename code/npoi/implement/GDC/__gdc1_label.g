# __gdc1_label.g is part of the GDC server
...
#
# $Id: __gdc1_label.g,v 19.0 2003/07/16 06:03:32 aips2adm Exp $
# ------------------------------------------------------------------------------
...
# Description:
# ------------
# This file contains the glish functions for labelling in gdc1 tools.  NB:
# These functions should be called only by gdc1 tools.

# glish function:
# ---------------
# __gdc1_labelprivate, __gdc1_labelgui, __gdc1_labelgui_update.

# Modification history:
# ---------------------
# 2000 Jun 12 - Nicholas Elias, USNO/NPOI
#               File created with glish functions __gdc1_labelprivate( ) and
#               __gdc1_labelgui{ }.
# 2000 Jun 19 - Nicholas Elias, USNO/NPOI
#               Glish function __gdc1_labelgui_update( ) added.
...
# Description:
# ------------
# This glish function creates label private member functions for a gdc1 tool.
...
const __gdc1_labelprivate := function( ref private ) {
...
# Description:
# ------------
# This glish function creates a label GUI for a gdc1 tool.
...
const __gdc1_labelgui := function( ref gui, ref w, ref private, public ) {
...
# __gdc1_labelgui_update

# Description:
# ------------
# This glish function updates a label GUI for a gdc1 tool.
...
const __gdc1_labelgui_update := function( ref gui, ref private, public ) {
