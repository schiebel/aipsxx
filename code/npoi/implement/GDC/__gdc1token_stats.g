# __gdc1token_stats.g is part of the GDC server
...
#
# $Id: __gdc1token_stats.g,v 19.0 2003/07/16 06:03:28 aips2adm Exp $
# ------------------------------------------------------------------------------
...
# Description:
# ------------
# This file contains the glish functions for statistics in gdc1token tools.
# NB: These functions should be called only by gdc1token tools.

# glish function:
# ---------------
# __gdc1token_statsgui, __gdc1token_statsgui_update.

# Modification history:
# ---------------------
# 2000 Jun 13 - Nicholas Elias, USNO/NPOI
#               File created with glish functions __gdc1token_statsgui{ } and
#               __gdc1token_statsgui_update{ } added.
...
# __gdc1token_statsgui

# Description:
# ------------
# This glish function creates a statistics GUI for a gdc1token tool.
...
const __gdc1token_statsgui := function( ref gui, ref w, ref private, public ) {
...
# __gdc1token_statsgui_update

# Description:
# ------------
# This glish function updates the stats GUI for a gdc1token tool.
...
const __gdc1token_statsgui_update := function( ref gui, ref private, public ) {
