# __gdc1token_edit.g is part of the GDC server
...
#
# $Id: __gdc1token_edit.g,v 19.0 2003/07/16 06:03:26 aips2adm Exp $
# ------------------------------------------------------------------------------
...
# Description:
# ------------
# This file contains the glish functions for editing in gdc1token tools.  NB:
# These functions should be called only by gdc1token tools.

# glish function:
# ---------------
# __gdc1token_editprivate, __gdc1token_editgui, __gdc1token_editgui_update.

# Modification history:
# ---------------------
# 2000 Jun 13 - Nicholas Elias, USNO/NPOI
#               File created with glish functions __gdc1token_editprivate( )
#               and __gdc1token_editgui{ }.
# 2000 Jun 19 - Nicholas Elias, USNO/NPOI
#               Glish function __gdc1token_editgui_update( ) added.
...
# __gdc1token_editprivate

# Description:
# ------------
# This glish function creates edit private member functions for a gdc1token
# tool.
...
const __gdc1token_editprivate := function( ref private ) {
...
# Description:
# ------------
# This glish function creates an edit GUI for a gdc1token tool.
...
const __gdc1token_editgui := function( ref gui, ref w, ref private, public ) {
  ...
  whenever gui.pgplot->fup do {
    ...
    if ( private.interpmethod == '' ) {
      if ( private.xorxy == 'X' ) {
        public.setflagx( xmin, xmax, private.gettoken(),
            gui.edit.flag->state() );
      } else {
        public.setflagxy( xmin, xmax, ymin, ymax, private.gettoken(),
            gui.edit.flag->state() );
      }
    } else {
      if ( private.xorxy == 'X' ) {
        public.interpolatex( xmin, xmax, private.gettoken(), private.getkeep(),
            private.interpmethod, private.getxmin( F ), private.getxmax( F ) );
      } else {
        public.interpolatexy( xmin, xmax, private.gettoken(),
            private.getkeep(), private.interpmethod, ymin, ymax,
            private.getxmin( F ), private.getxmax( F ), private.getymin( F ),
            private.getymax( F ) );
      }
    }
...
# __gdc1token_editgui_update

# Description:
# ------------
# This glish function updates an edit GUI for a gdc1token tool.
...
const __gdc1token_editgui_update := function( ref gui, ref private, public ) {
