# __gdc1token_label.g is part of the GDC server
...
#
# $Id: __gdc1token_label.g,v 19.0 2003/07/16 06:03:26 aips2adm Exp $
# ------------------------------------------------------------------------------
...
# Description:
# ------------
# This file contains the glish functions for labelling in gdc1token tools.  NB:
# These functions should be called only by gdc1token tools.

# glish function:
# ---------------
# __gdc1token_labelprivate, __gdc1token_labelgui, __gdc1token_labelgui_update.

# Modification history:
# ---------------------
# 2000 Jun 12 - Nicholas Elias, USNO/NPOI
#               File created with glish functions __gdc1token_labelprivate( )
#               and __gdc1token_labelgui{ }.
# 2000 Jun 19 - Nicholas Elias, USNO/NPOI
#               Glish function __gdc1token_labelgui_update( ) added.
...
# __gdc1token_labelprivate

# Description:
# ------------
# This glish function creates label private member functions for a gdc1token
# tool.
...
const __gdc1token_labelprivate := function( ref private ) {
...
# __gdc1token_labelgui

# Description:
# ------------
# This glish function creates a label GUI for a gdc1token tool.
...
const __gdc1token_labelgui := function( ref gui, ref w, ref private, public ) {
...
# __gdc1token_labelgui_update

# Description:
# ------------
# This glish function updates a label GUI for a gdc1token tool.
...
const __gdc1token_labelgui_update := function( ref gui, ref private, public ) {
