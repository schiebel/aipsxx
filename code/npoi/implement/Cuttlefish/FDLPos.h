//#FDLPos.h is part of the Cuttlefish server
//#Copyright (C) 2001
...
//#
//# $Id: FDLPos.h,v 19.4 2004/11/30 17:50:40 ddebonis Exp $
// -----------------------------------------------------------------------------
...
Description:
------------
This file contains the include information for the FDLPos.cc file.
...
#ifndef NPOI_FDLPOS_H
#define NPOI_FDLPOS_H
...
// <summary>A class for manipulating FDL positions</summary>
...
// <synopsis>
// FDLPos{ } is a class designed for manipulation of FDL positions.  FDL
// positions are 1-dimensional/tokenized and telescoped-based, so FDLPos{ }
...
class FDLPos : public __IBData1 {

  public:

    // Create an FDLPos{ } object.
    FDLPos( String& oFileIn, const uInt& uiInputBeamIn );
    FDLPos( const ObjectID& oObjectIDIn, const Vector<Double>& oXIn,
        Double& dXMinIn, Double& dXMaxIn, Vector<String>& oTokenIn,
        const Bool& bKeepIn, const Bool& bWeightIn, const Bool& bXCalcIn,
        String& oInterpIn );
    FDLPos( const ObjectID& oObjectIDIn, Double& dXMinIn, Double& dXMaxIn,
    ...
    FDLPos( const FDLPos& oFDLPosIn );
    
    // Delete an FDLPos{ } object.
    ~FDLPos( void );
    ...
    // Return the list of FDLPos{ } methods.
    virtual Vector<String> methods( void ) const;

    // Return the list of FDLPos{ } methods where no trace is printed.
    virtual Vector<String> noTraceMethods( void ) const;

    // The Cuttlefish server uses this method to pass arguments to FDLPos{ }
