//#GrpDelay.h is part of the Cuttlefish server
//#Copyright (C) 2001
...
//#
//# $Id: GrpDelay.h,v 19.4 2004/11/30 17:50:40 ddebonis Exp $
// -----------------------------------------------------------------------------
...
Description:
------------
This file contains the include information for the GrpDelay.cc file.
...
#ifndef NPOI_GRPDELAY_H
#define NPOI_GRPDELAY_H
...
// <synopsis>
// GrpDelay{ } is a class designed for manipulation of group delays.  Group
// delays are 1-dimensional/tokenized and telescoped-based, so GrpDelay{ }
// inherits __IBData1 and uses the initialize( ).  It is meant to be inherited
...
class GrpDelay : public __IBData1 {

  public:

    // Create a GrpDelay{ } object.
    GrpDelay( String& oFileIn, const uInt& uiInputBeamIn );
    GrpDelay( const ObjectID& oObjectIDIn, const Vector<Double>& oXIn,
        Double& dXMinIn, Double& dXMaxIn, Vector<String>& oTokenIn,
        const Bool& bKeepIn, const Bool& bWeightIn, const Bool& bXCalcIn,
        String& oInterpIn );
    GrpDelay( const ObjectID& oObjectIDIn, Double& dXMinIn, Double& dXMaxIn,
    ...
    GrpDelay( const GrpDelay& oGrpDelayIn );
    
    // Delete a GrpDelay{ } object.
    ~GrpDelay( void );
    ...
    // Return the list of GrpDelay{ } methods.
    virtual Vector<String> methods( void ) const;

    // Return the list of GrpDelay{ } methods where no trace is printed.
    virtual Vector<String> noTraceMethods( void ) const;

    // The Cuttlefish server uses this method to pass arguments to GrpDelay{ }
