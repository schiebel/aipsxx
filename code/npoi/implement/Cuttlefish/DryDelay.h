//#DryDelay.h is part of the Cuttlefish server
//#Copyright (C) 2001
...
//#
//# $Id: DryDelay.h,v 19.4 2004/11/30 17:50:40 ddebonis Exp $
// -----------------------------------------------------------------------------
...
Description:
------------
This file contains the include information for the DryDelay.cc file.
...
#ifndef NPOI_DRYDELAY_H
#define NPOI_DRYDELAY_H
...
// <synopsis>
// DryDelay{ } is a class designed for manipulation of dry delays.  Dry delays
// are 1-dimensional/tokenized and telescoped-based, so DryDelay{ } inherits
...
class DryDelay : public __IBData1 {

  public:

    // Create a DryDelay{ } object.
    DryDelay( String& oFileIn, const uInt& uiInputBeamIn );
    DryDelay( const ObjectID& oObjectIDIn, const Vector<Double>& oXIn,
        Double& dXMinIn, Double& dXMaxIn, Vector<String>& oTokenIn,
        const Bool& bKeepIn, const Bool& bWeightIn, const Bool& bXCalcIn,
        String& oInterpIn );
    DryDelay( const ObjectID& oObjectIDIn, Double& dXMinIn, Double& dXMaxIn,
    ...
    DryDelay( const DryDelay& oDryDelayIn );
    
    // Delete a DryDelay{ } object.
    ~DryDelay( void );
    ...
    // Return the list of DryDelay{ } methods.
    virtual Vector<String> methods( void ) const;

    // Return the list of DryDelay{ } methods where no trace is printed.
    virtual Vector<String> noTraceMethods( void ) const;

    // The Cuttlefish server uses this method to pass arguments to DryDelay{ }
