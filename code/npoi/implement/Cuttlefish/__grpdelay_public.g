# __grpdelay_public.g is part of the Cuttlefish server
...
#
# $Id: __grpdelay_public.g,v 19.0 2003/07/16 06:02:48 aips2adm Exp $
# ------------------------------------------------------------------------------
...
#               File created with glish function __grpdelay_public( ).
...
# Description
# -----------
# This glish function adds public member functions to the group-delay tool.
...
const __grpdelay_public := function( ref gui, ref private, ref public ) {
