# __delayjitter_public.g is part of the Cuttlefish server
...
#
# $Id: __delayjitter_public.g,v 19.0 2003/07/16 06:02:47 aips2adm Exp $
# ------------------------------------------------------------------------------

# __delayjitter_public.g
...
# the delay-jitter tool.

# glish functions:
# ----------------
# __delayjitter_public.

# Modification history:
# ---------------------
# 2001 May 11 - Nicholas Elias, USNO/NPOI
#               File created with glish function __delayjitter_public( ).
...
# Description
# -----------
# This glish function adds public member functions to the delay-jitter tool.
...
const __delayjitter_public := function( ref gui, ref private, ref public ) {
