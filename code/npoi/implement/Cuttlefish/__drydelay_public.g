# __drydelay_public.g is part of the Cuttlefish server
...
#
# $Id: __drydelay_public.g,v 19.0 2003/07/16 06:02:46 aips2adm Exp $
# ------------------------------------------------------------------------------
...
#               File created with glish function __drydelay_public( ).
...
# Description
# -----------
# This glish function adds public member functions to the dry-delay tool.
...
const __drydelay_public := function( ref gui, ref private, ref public ) {
