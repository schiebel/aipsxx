# __fdlpos_public.g is part of the Cuttlefish server
...
#
# $Id: __fdlpos_public.g,v 19.0 2003/07/16 06:02:38 aips2adm Exp $
# ------------------------------------------------------------------------------
...
#               File created with glish function __fdlpos_public( ).
...
# Description
# -----------
# This glish function adds public member functions to the FDL-position tool.
...
const __fdlpos_public := function( ref gui, ref private, ref public ) {
