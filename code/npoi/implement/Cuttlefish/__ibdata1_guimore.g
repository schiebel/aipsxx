# __ibdata1_guimore.g is part of the Cuttlefish server
# Copyright (C) 2001
...
#
# $Id: __ibdata1_guimore.g,v 19.0 2003/07/16 06:02:39 aips2adm Exp $
# ------------------------------------------------------------------------------
...
# Description:
# ------------
# This file contains the glish functions for the gui in __ibdata1 tools
# (augmenting the gui for gdc1token tools).  NB: These functions should be
# called only by __ibdata1 tools.

# glish function:
# ---------------
# __ibdata1_guimore, __ibdata1_guimore_dumphds, __ibdata1_guimore_xaxis,
# __ibdata1_guimore_xaxis_update.

# Modification history:
# ---------------------
# 2001 Mar 27 - Nicholas Elias, USNO/NPOI
#               File created with glish functions __ibdata1_guimore( ),
#               __ibdata1_guimore_dumphds( ), __ibdata1_guimore_xaxis( ) and
#               __ibdata1_guimore_xaxis_update( ).
...
# __ibdata1 tool (an augmented gdc1token tool).
...
const __ibdata1_guimore := function( ref gui, ref w, ref private, public ) {
  ...
  const val private.guimore_reset := function( ) {
    wider gui, w, private, public;
    __ibdata1_guimore_xaxis_update( public.xlabeltokens()[1], gui, private,
        public );
    return( T );
  }
  ...
  const val private.bdumphds := function( ref gui, ref w, ref private,
    ...
    whenever gui.bdumphds->press do {
      __ibdata1_guimore_dumphds( gui, w, private, public );
    }
  ...
  const val private.bxaxis := function( ref gui, ref w, ref private,
    ...
    whenever gui.bxaxis->press do {
      __ibdata1_guimore_xaxis( gui, w, private, public );
    }
...
# __ibdata1_guimore_dumphds

# Description:
# ------------
# This glish function creates the dumphds GUI for an __ibdata1 tool (augmented
# to a gdc1token tool).
...
const __ibdata1_guimore_dumphds := function( ref gui, ref w, ref private,
    public ) {
...
# __ibdata1_guimore_xaxis

# Description:
# ------------
# This glish function creates the x-axis GUI for an __ibdata1 tool (augmented to
# a gdc1token tool).
...
const __ibdata1_guimore_xaxis := function( ref gui, ref w, ref private,
    public ) {
...
# Description:
# ------------
# This glish function update the x-axis GUI for an __ibdata1 tool (augmented to
# a gdc1token tool).
...
const __ibdata1_guimore_xaxis_update := function( xtoken, ref gui, ref private,
    public ) {
