# __natjitter_public.g is part of the Cuttlefish server
...
#
# $Id: __natjitter_public.g,v 19.0 2003/07/16 06:02:41 aips2adm Exp $
# ------------------------------------------------------------------------------

# __natjitter_public.g
...
#               File created with glish function __natjitter_public( ).
...
# Description
# -----------
# This glish function adds public member functions to the NAT-jitter tool.
...
const __natjitter_public := function( ref gui, ref private, ref public ) {
