//#NATJitter.h is part of the Cuttlefish server
//#Copyright (C) 2001
...
//#
//# $Id: NATJitter.h,v 19.4 2004/11/30 17:50:40 ddebonis Exp $
// -----------------------------------------------------------------------------
...
Description:
------------
This file contains the include information for the NATJitter.cc file.
...
#ifndef NPOI_NATJITTER_H
#define NPOI_NATJITTER_H
...
// <summary>A class for manipulating NAT jitters</summary>
...
// <synopsis>
// NATJitter{ } is a class designed for manipulation of NAT jitters.  NAT
// jitters are 1-dimensional/tokenized and telescoped-based, so NATJitter{ }
// inherits __IBData1 and uses the initialize( ).
// </synopsis>

// <example>
// <src>NATJitter.cc</src>
// <srcblock>{}</srcblock>
// </example>
...
class NATJitter : public __IBData1 {

  public:

    // Create an NATJitter{ } object.
    NATJitter( String& oFileIn, const uInt& uiInputBeamIn );
    NATJitter( const ObjectID& oObjectIDIn, const Vector<Double>& oXIn,
        Double& dXMinIn, Double& dXMaxIn, Vector<String>& oTokenIn,
        const Bool& bKeepIn, const Bool& bWeightIn, const Bool& bXCalcIn,
        String& oInterpIn );
    NATJitter( const ObjectID& oObjectIDIn, Double& dXMinIn, Double& dXMaxIn,
    ...
    NATJitter( const NATJitter& oNATJitterIn );
    
    // Delete an NATJitter{ } object.
    ~NATJitter( void );
    ...
    // Return the list of NATJitter{ } methods.
    virtual Vector<String> methods( void ) const;

    // Return the list of NATJitter{ } methods where no trace is printed.
    virtual Vector<String> noTraceMethods( void ) const;

    // The Cuttlefish server uses this method to pass arguments to NATJitter{ }
