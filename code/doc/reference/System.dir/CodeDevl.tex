...
\exeref{UPlock}, \exeref{UPtmpl}, \exeref{UPload}, \exeref{UPcasa}) exist.
...
\subsection{\exe{UPcasa}}
\label{UPcasa}
\index{UPcasa@\exe{UPcasa}}
\index{source files |see{\exe{UPcasa}}}
...
\noindent
The \exe{UPcasa} script lists all the basic casa library packages in
hierarchal order.
