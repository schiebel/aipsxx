...
var gDocTable = new Array(
   new hrefList("slide0155.htm", 1, 1),
   new hrefList("slide0216.htm", 1, 2),
   new hrefList("slide0217.htm", 1, 3),
   new hrefList("slide0218.htm", 1, 4),
   new hrefList("slide0219.htm", 1, 5),
   new hrefList("slide0220.htm", 1, 6),
   new hrefList("slide0221.htm", 1, 7),
   new hrefList("slide0222.htm", 1, 8),
   new hrefList("slide0223.htm", 1, 9),
   new hrefList("slide0224.htm", 1, 10),
   new hrefList("slide0225.htm", 1, 11),
   new hrefList("slide0226.htm", 1, 12),
   new hrefList("slide0227.htm", 1, 13),
   new hrefList("slide0228.htm", 1, 14),
   new hrefList("slide0229.htm", 1, 15),
   new hrefList("slide0230.htm", 1, 16),
   new hrefList("slide0231.htm", 1, 17),
   new hrefList("slide0240.htm", 1, 18),
   new hrefList("slide0232.htm", 1, 19),
   new hrefList("slide0236.htm", 1, 20)
);
