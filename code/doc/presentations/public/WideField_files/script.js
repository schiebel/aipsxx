...
var gDocTable = new Array(
   ...
   new hrefList("slide0066.htm", 1, 2),
   new hrefList("slide0067.htm", 1, 3),
   new hrefList("slide0030.htm", 1, 4),
   new hrefList("slide0005.htm", 1, 5),
   new hrefList("slide0028.htm", 1, 6),
   new hrefList("slide0065.htm", 1, 7),
   new hrefList("slide0026.htm", 1, 8),
   new hrefList("slide0012.htm", 1, 9),
   new hrefList("slide0022.htm", 1, 10),
   new hrefList("slide0014.htm", 1, 11),
   new hrefList("slide0006.htm", 1, 12),
   new hrefList("slide0024.htm", 1, 13),
   new hrefList("slide0036.htm", 1, 14),
   new hrefList("slide0016.htm", 1, 15),
   new hrefList("slide0033.htm", 1, 16),
   new hrefList("slide0027.htm", 1, 17),
   new hrefList("slide0017.htm", 1, 18),
   new hrefList("slide0013.htm", 1, 19),
   new hrefList("slide0034.htm", 1, 20),
   new hrefList("slide0018.htm", 1, 21),
   new hrefList("slide0031.htm", 1, 22),
   new hrefList("slide0015.htm", 1, 23),
   new hrefList("slide0029.htm", 1, 24),
   new hrefList("slide0050.htm", 1, 25),
   new hrefList("slide0051.htm", 1, 26),
   new hrefList("slide0019.htm", 1, 27),
   new hrefList("slide0008.htm", 1, 28),
   new hrefList("slide0064.htm", 1, 29),
   new hrefList("slide0023.htm", 1, 30),
   new hrefList("slide0010.htm", 1, 31),
   new hrefList("slide0011.htm", 1, 32),
   new hrefList("slide0063.htm", 1, 33),
   new hrefList("slide0004.htm", 1, 34),
   new hrefList("slide0035.htm", 1, 35),
   new hrefList("slide0021.htm", 1, 36),
   new hrefList("slide0068.htm", 1, 37)
);
