...
var g_isKiosk = 1;var g_animManager = null;

var ENDSHOW_MESG="End of slide show, click to exit.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=77, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   ...
   new hrefList("slide0176.htm", 1, 2),
   new hrefList("slide0153.htm", 1, 3),
   new hrefList("slide0106.htm", 1, 4),
   new hrefList("slide0142.htm", 1, 5),
   new hrefList("slide0175.htm", 1, 6),
   new hrefList("slide0215.htm", 1, 7),
   new hrefList("slide0224.htm", 1, 8),
   new hrefList("slide0217.htm", 1, 9),
   new hrefList("slide0182.htm", 1, 10),
   new hrefList("slide0251.htm", 1, 11),
   new hrefList("slide0233.htm", 1, 12),
   new hrefList("slide0308.htm", 1, 13),
   new hrefList("slide0235.htm", 1, 14),
   new hrefList("slide0245.htm", 1, 15),
   new hrefList("slide0301.htm", 1, 16),
   new hrefList("slide0307.htm", 1, 17),
   new hrefList("slide0306.htm", 1, 18),
   new hrefList("slide0302.htm", 1, 19),
   new hrefList("slide0304.htm", 1, 20),
   new hrefList("slide0303.htm", 1, 21),
   new hrefList("slide0305.htm", 1, 22),
   new hrefList("slide0309.htm", 1, 23),
   new hrefList("slide0311.htm", 1, 24),
   new hrefList("slide0252.htm", 1, 25),
   new hrefList("slide0239.htm", 1, 26),
   new hrefList("slide0310.htm", 1, 27),
   new hrefList("slide0159.htm", 1, 28),
   new hrefList("slide0192.htm", 1, 29),
   new hrefList("slide0193.htm", 1, 30),
   new hrefList("slide0194.htm", 1, 31),
   new hrefList("slide0196.htm", 1, 32),
   new hrefList("slide0197.htm", 1, 33),
   new hrefList("slide0198.htm", 1, 34),
   new hrefList("slide0200.htm", 1, 35),
   new hrefList("slide0248.htm", 1, 36),
   new hrefList("slide0201.htm", 1, 37),
   new hrefList("slide0203.htm", 1, 38),
   new hrefList("slide0202.htm", 1, 39),
   new hrefList("slide0246.htm", 1, 40),
   new hrefList("slide0218.htm", 1, 41),
   new hrefList("slide0230.htm", 1, 42),
   new hrefList("slide0219.htm", 1, 43),
   new hrefList("slide0225.htm", 1, 44),
   new hrefList("slide0214.htm", 1, 45),
   new hrefList("slide0216.htm", 1, 46),
   new hrefList("slide0221.htm", 1, 47),
   new hrefList("slide0226.htm", 1, 48),
   new hrefList("slide0300.htm", 1, 49),
   new hrefList("slide0243.htm", 1, 50),
   new hrefList("slide0247.htm", 1, 51),
   new hrefList("slide0231.htm", 1, 52),
   new hrefList("slide0207.htm", 1, 53),
   new hrefList("slide0208.htm", 1, 54),
   new hrefList("slide0032.htm", 1, 55),
   new hrefList("slide0315.htm", 1, 56),
   new hrefList("slide0241.htm", 1, 57),
   new hrefList("slide0254.htm", 1, 58),
   new hrefList("slide0098.htm", 1, 59),
   new hrefList("slide0257.htm", 1, 60),
   new hrefList("slide0258.htm", 1, 61),
   new hrefList("slide0259.htm", 1, 62),
   new hrefList("slide0260.htm", 1, 63),
   new hrefList("slide0261.htm", 1, 64),
   new hrefList("slide0262.htm", 1, 65),
   new hrefList("slide0184.htm", 1, 66),
   new hrefList("slide0244.htm", 1, 67),
   new hrefList("slide0183.htm", 1, 68),
   new hrefList("slide0264.htm", 1, 69),
   new hrefList("slide0273.htm", 1, 70),
   new hrefList("slide0275.htm", 1, 71),
   new hrefList("slide0210.htm", 1, 72),
   new hrefList("slide0211.htm", 1, 73),
   new hrefList("slide0209.htm", 1, 74),
   new hrefList("slide0071.htm", 1, 75),
   new hrefList("slide0084.htm", 1, 76),
   new hrefList("slide0291.htm", 1, 77)
);
