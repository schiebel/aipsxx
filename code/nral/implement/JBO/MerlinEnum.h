//# MerlinEnum.h: Enumerators common to the VLA Module
...
//#
//#
//# $Id: MerlinEnum.h,v 19.3 2004/11/30 17:50:40 ddebonis Exp $

#ifndef NRAL_MERLINENUM_H
#define NRAL_MERLINENUM_H
...
public:
  ...
  static String name(MerlinEnum::CorrMode modeEnum);

  // Convert a given String to a CorrMode enumerator
  static MerlinEnum::CorrMode corrMode(const String& modeString);
};
#endif
