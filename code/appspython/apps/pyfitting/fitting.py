from _pyfitting import fitting
from pyfunctionals import *
...
class fitserver:
	...
	dtype = NUM.Float
	    ...
	    or x.type() == NUM.Complex
	    or y.type() == NUM.Complex
	    or wt.type() == NUM.Complex):
	    ftype = "cx%s" % fitfunc
	    dtype = NUM.Complex
    ...
    def functional(self, fnct, x, y, sd=None, wt=1.0, mxiter=50, fid=0):
	self._fit(fitfunc="functional", fnct=fnct, x=x, y=y, sd=sd, wt=wt,
		  mxiter=mxiter, fid=fid) 
