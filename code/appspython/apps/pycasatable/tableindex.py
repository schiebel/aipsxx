...
#
# $Id: tableindex.py,v 1.3 2006/09/26 04:45:01 gvandiep Exp $

# Make interface to class TableIndexProxy available.
from _pycasatable import TableIndex
import table
...
class tableindex(TableIndex):
    ...
    def __init__(self, table, columns, sort=True):
        cols = columns;
        if isinstance(cols, str):
            cols = [cols] ;
        TableIndex.__init__ (self, table, cols, sort);
