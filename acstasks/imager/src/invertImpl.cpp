...
*
* "@(#) $Id: invertImpl.cpp,v 1.9 2005/05/13 18:56:04 ddebonis Exp $"
*
* who       when      what
* --------  --------  ----------------------------------------------
...
/* ----------------------------------------------------------------*/
invertImpl::invertImpl(const ACE_CString &name,
                       maci::ContainerServices *containerServices)
  : acscomponent::ACSComponentImpl(name, containerServices),
    parameterTask(name, containerServices)
{
    ACS_TRACE("::invertImpl::invertImpl");
}
/* ----------------------------------------------------------------*/
invertImpl::~invertImpl()
{
    ACS_TRACE("::invertImpl::~invertImpl");
    ACS_DEBUG_PARAM("::invertImpl::~invertImpl", "Destroying %s...", name());
}
/* --------------------- [ CORBA interface ] ----------------------*/
void invertImpl::go(ParameterSet& tpset)
{
   ImagerTask task;
...
MACI_DLL_SUPPORT_FUNCTIONS(invertImpl)
/* ----------------------------------------------------------------*/
