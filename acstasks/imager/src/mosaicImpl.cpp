...
*
* "@(#) $Id: mosaicImpl.cpp,v 1.10 2005/05/13 18:56:04 ddebonis Exp $"
*
* who       when      what
* --------  --------  ----------------------------------------------
...
/* ----------------------------------------------------------------*/
mosaicImpl::mosaicImpl(const ACE_CString &name,
                       maci::ContainerServices *containerServices)
  : acscomponent::ACSComponentImpl(name, containerServices),
    parameterTask(name, containerServices)
{
    ACS_TRACE("::mosaicImpl::mosaicImpl");
}
/* ----------------------------------------------------------------*/
mosaicImpl::~mosaicImpl()
{
    ACS_TRACE("::mosaicImpl::~mosaicImpl");
    ACS_DEBUG_PARAM("::mosaicImpl::~mosaicImpl", "Destroying %s...", name());
}
/* --------------------- [ CORBA interface ] ----------------------*/
void mosaicImpl::go(ParameterSet& tpset)
{
   ImagerTask task;
...
MACI_DLL_SUPPORT_FUNCTIONS(mosaicImpl)
/* ----------------------------------------------------------------*/
